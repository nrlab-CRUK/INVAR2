...
The table below tracks the number of loci per input sample across the progression of the pipeline. The final four columns gives the classification of the sample as defined by the specified filter conditions. 
...
N_LOCI_LOCUS_NOISE.PASS : is the number of those loci that pass the LOCUS_NOISE filter. ie the number of loci that have mutations in less than "PROPORTION_OF_CONTROLS" loci (parameter set in the nextflow.config file).
MUTANT_LOCI_PATIENT_SPECIFIC : is the number of patient specific LOCI in a sample that have mutations.
MUTANT_LOCI_NON_PATIENT_SPECIFIC : is the number of non-patient specific LOCI in a sample that have mutations.
N_READS_MUTATED_PTSPEC : is the number of mutated reads found in the loci that passed the LOCUS_NOISE filter. 

, N_READS_MUTATED_NONPTSPEC, 
           N_READS_MUTATED_PRE_OS_PTSPEC, N_READS_MUTATED_PRE_OS_NONPTSPEC,
           # MUTANT_OUTLIER.PASS, 

PATIENT_SPECIFIC.PASS_AL : is number of patient specific READS (not loci!!) that pass all filters and are mutated.
NON_SPECIFIC.PASS_ALL : is number of non-patient specific READS (not loci!!) that pass all filters and are mutated.
